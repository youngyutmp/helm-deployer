module github.com/entwico/helm-deployer
...
require (
	...
	github.com/go-task/task v2.1.1+incompatible // indirect
	...
	github.com/mgechev/revive v0.0.0-20181003185657-da63d0a9655d // indirect
	...
	k8s.io/apiserver v0.0.0-20180808173522-f26e5b1f0e9c
	k8s.io/client-go v8.0.0+incompatible
	k8s.io/helm v0.0.0-20180808181036-13d67a9b0364
