...
func TestConfigWithOverrides(t *testing.T) {
	...
	tmpfile, err := ioutil.TempFile("", "helm-deployer")
	assert.Nil(t, err)
	...
	os.Setenv("HELM_DEPLOYER_DB_PATH", "db.bolt")
	os.Setenv("HELM_DEPLOYER_API_HOST", "api-host")
	os.Setenv("HELM_DEPLOYER_API_PORT", "8000")
